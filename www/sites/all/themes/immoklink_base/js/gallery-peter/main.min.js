...
my.oldie = 1 === $("html.lt-ie9").length, my.useAddress = !0, my.useAddress = !my.oldie, my.clicked = !1, my.winWidth = $(window).width(), my.screenWidth = screen.width, my.slidesize = "big", my.screenWidth < 480 && (my.slidesize = "mobile"), my.slideDur = 1200, my.animationInterval = 1700;
...
my.frag = {}, my.detachSlides = !0, my.detachSlides = 0 === $("html.ie9, html.lt-ie9").length, my.prevAnimated = "", $(document).ready(function() {
    if (my.useAddress) {
        ...
        $.address.state("/").init(function() {
			/*a.grid-item, a.logo,*/
            $("body").on("click", ".main-nav a:not(.no-state),.sub-nav a:not(.no-state)", function(e) {
